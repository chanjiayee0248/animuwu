export const ANIME_SORT_DIRECTION_LABEL_TO_PARAM_OBJECT = {
    "Desc.": "desc",
    "Asc.": "asc",
} as const;

export type AnimeSortDirectionLabelType = keyof typeof ANIME_SORT_DIRECTION_LABEL_TO_PARAM_OBJECT;
export type AnimeSortDirectionParamType = typeof ANIME_SORT_DIRECTION_LABEL_TO_PARAM_OBJECT[AnimeSortDirectionLabelType];
...
export function getAnimeSortDirectionParamFromLabel(label: AnimeSortDirectionLabelType): AnimeSortDirectionParamType {
    return ANIME_SORT_DIRECTION_LABEL_TO_PARAM_OBJECT[label];
}

export function getAnimeSortDirectionLabelFromParam(param: DefinedAnimeSortDirectionParamType): AnimeSortDirectionLabelType {
    for (const [label, value] of Object.entries(ANIME_SORT_DIRECTION_LABEL_TO_PARAM_OBJECT)) {

export const ANIME_MEDIA_FORMAT_LABEL_TO_PARAM_OBJECT = {
    "All": null,
    "TV": "tv",
    "Movie": "movie",
    "OVA": "ova",
...
export type AnimeMediaFormatLabelType = keyof typeof ANIME_MEDIA_FORMAT_LABEL_TO_PARAM_OBJECT;
export type AnimeMediaFormatParamType = typeof ANIME_MEDIA_FORMAT_LABEL_TO_PARAM_OBJECT[AnimeMediaFormatLabelType];
...
export function getAnimeMediaFormatParamFromLabel(label: AnimeMediaFormatLabelType): AnimeMediaFormatParamType {
    return ANIME_MEDIA_FORMAT_LABEL_TO_PARAM_OBJECT[label];
}
...
export function getAnimeMediaFormatLabelFromParam(
    ...
    for (const [label, value] of Object.entries(ANIME_MEDIA_FORMAT_LABEL_TO_PARAM_OBJECT)) {

export const ANIME_SORT_CATEGORY_LABEL_TO_PARAM_OBJECT = {
    "MAL ID": "mal_id",
    "Title": "title",
...
export type AnimeSortCategoryLabelType = keyof typeof ANIME_SORT_CATEGORY_LABEL_TO_PARAM_OBJECT;
export type AnimeSortCategoryParamType = typeof ANIME_SORT_CATEGORY_LABEL_TO_PARAM_OBJECT[AnimeSortCategoryLabelType];
...
export function getAnimeSortCategoryParamFromLabel(label: AnimeSortCategoryLabelType): AnimeSortCategoryParamType {
    return ANIME_SORT_CATEGORY_LABEL_TO_PARAM_OBJECT[label];
}

export function getAnimeSortCategoryLabelFromParam(param: DefinedAnimeSortCategoryParamType): AnimeSortCategoryLabelType {
    for (const [label, value] of Object.entries(ANIME_SORT_CATEGORY_LABEL_TO_PARAM_OBJECT)) {
